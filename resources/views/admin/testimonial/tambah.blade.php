        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <strong>Tambah Testimonial</strong>
                </div>
				<form class="form-horizontal m-t-40" enctype="multipart/form-data" action="{{ URL('dashboard/testimonial/prosestambah') }}" method="POST">
					{{ csrf_field() }}
                    <div class="card-body">
						<div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ \App\Helpers\General::validForm($errors->first('nama_testimonials')) }}" id="nama_testimonials" type="text" name="nama_testimonials" value="{{Request::old('nama_testimonials')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ \App\Helpers\General::validForm($errors->first('jabatan_testimonials')) }}" id="jabatan_testimonials" type="text" name="jabatan_testimonials" value="{{Request::old('jabatan_testimonials')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control {{ \App\Helpers\General::validForm($errors->first('konten_testimonials')) }}" id="konten_testimonials" name="konten_testimonials" rows="5">{{Request::old('konten_testimonials')}}</textarea>
